package br.com.julia.controller;
...
import br.com.julia.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public List<Produto> listarProdutos() {
		/*
		 * Produto p1 = new Produto("Celular Sangue sunga ", 35, 1299.99); Produto p2 =
		 * new Produto("Cafeteira arno ", 10, 199.99); Produto p3 = new
	...
	@GetMapping("/{id}")
	public ResponseEntity<Produto> findByOd(@PathVariable Long id) {
